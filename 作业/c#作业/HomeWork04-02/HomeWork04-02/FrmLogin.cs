...
namespace HomeWork04_02
{
    public partial class FrmAdmin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            string strSQL = "sp_selectUsers";
            int count = Convert.ToInt32(helper.ExecuteScalar(strSQL,CommandType.StoredProcedure,new SqlParameter("@userName", txtUserName.Text.Trim()),
