...
namespace Class_11_30
{
    ...
    public class MyObjectController
    {
        ...
        //得到万事万物中的某种信息的视图实例
        //人员信息管理
         protected MyObjectView view = new MyObjectPersonView();
        ...
        //公交车信息管理
        //private MyObjectView view = new MyObjectBusView();
        ...
        //private IMyObjectDAO dao = new MyObjectPersonDAOSorteList();
        //private IMyObjectDAO dao = new MyObjectPersonDAOList();
        protected IMyObjectDAO dao = new MyObjectPersonDAODiciionary();
        
        //书DAO
        //private MyObjectDAO dao = new MyObjectBookDAO();
        //private IMyObjectDAO dao = new MyObjectBookDAOArrayList();
        //private IMyObjectDAO dao = new MyObjectBookDAOHashtable();
        //private IMyObjectDAO dao = new MyObjecBookDAOSorteList();

        //公交车DAO
        //private IMyObjectDAO dao = new MyObjectBusDAOArrayList();
        //private IMyObjectDAO dao = new MyObjectBusDAOHashtable();
        //private IMyObjectDAO dao = new MyObjectBusDAOSorteList();
        ...
        //结构版本
        protected UserStructDAO daoUserStruct = new UserStructDAO();
        public void Start()
        {
            do
            {
        ...
        public void LogIn()
        {
            ...
            UserStruct logInUser = view.LogIn();
            //correctUser是从数据仓库得到的正确的用户对象
            //User correctUser = daoUser.SelectByUsername(logInUser.Username);
            UserStruct correctUser = daoUserStruct.SelectByUsername(logInUser.Username);
    ...
    /// 自定义泛型
    /// </summary>
    /// <typeparam name="A">界面呈现视图</typeparam>
    /// <typeparam name="B">数据访问对象</typeparam>
    public class MyObjectController<A,B>:MyObjectController where A:MyObjectView,new() where B:IMyObjectDAO,new()
    {
